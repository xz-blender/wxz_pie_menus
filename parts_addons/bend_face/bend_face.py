...
class BendFaceOperator(bpy.types.Operator):
    ...
    def hint(self):
        if self.prop_extend_mode:
            gui.txtall = ['Sliding rotation', 'Left-mouse: Rotate', 'Right-mouse: Move', 'Hold Ctrl: snapping, F key: face normal', 'S key: sliding mode', 'Press Q to confirm, Esc to cancel.']
        else:
            gui.txtall = ['Left-mouse: Rotate', 'Right-mouse: Move', 'Hold Ctrl: snapping, F key: face normal', 'S key: sliding mode', 'Press Q to confirm, Esc to cancel.']
