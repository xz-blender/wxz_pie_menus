...
def draw_handle_add(arg):
    global handle3d
    print("add draw")
    handle3d = bpy.types.SpaceView3D.draw_handler_add(draw_3d, arg, "WINDOW", "POST_VIEW")


def text_handle_add(arg):
    global handle3dtext
    print("add text")
    handle3dtext = bpy.types.SpaceView3D.draw_handler_add(draw_text_callback, arg, "WINDOW", "POST_PIXEL")
