...
class nbnb_Prefs(bpy.types.AddonPreferences):
    ...
    def draw(self, context):
        lay=self.layout
        row=lay.row()
        row.operator("wm.url_open", text="插件视频1",icon="FILE_MOVIE").url = "https://www.bilibili.com/video/BV1KN41127y8"
        row.operator("wm.url_open", text="插件视频2",icon="FILE_MOVIE").url = "https://www.bilibili.com/video/BV12w4m1Z7UG"
        row.operator("wm.url_open", text="插件视频3",icon="FILE_MOVIE").url = "https://www.bilibili.com/video/BV17u4m1F7ia"
        row=lay.row()
        row.operator("wm.url_open", text="插件视频4",icon="FILE_MOVIE").url = "https://www.bilibili.com/video/BV1LH4y1g73M"
        row.operator("wm.url_open", text="插件视频5",icon="FILE_MOVIE").url = "https://www.bilibili.com/video/BV16T421a7Ri"
        row.operator("wm.url_open", text="插件视频6",icon="FILE_MOVIE").url = "https://www.bilibili.com/video/BV1bj421Q7HE"
        row=lay.row()
        row.operator("wm.url_open", text="插件视频7",icon="FILE_MOVIE").url = "https://www.bilibili.com/video/BV19kafecEQe"
