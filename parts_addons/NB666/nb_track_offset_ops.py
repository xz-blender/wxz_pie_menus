...
class NB_TrackOffset_Operator(bpy.types.Operator):
    bl_idname = "nb_frame.track_offset"
    bl_label = "牛逼跟随错帧"
    bl_description = "点他牛逼的跟随错帧"
...
#############################vel########vel########vel################################# 
        ...
        for i in selboneS:    
            genSuiCuoZhen(i,bpy.context.scene.Prop_nb_666.cInfluence)
