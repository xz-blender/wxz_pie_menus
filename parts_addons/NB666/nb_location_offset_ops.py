...
class NB_LoctionOffset_Operator(bpy.types.Operator):
    bl_idname = "nb_frame.loction_offset"
    bl_label = "牛逼位置错帧"
    bl_description = "点他牛逼的位置错帧"
...
#                    i.show_render = False
        ...
        def weiZHCuoZhen(Abone,gensuiAmp =1):
            #####
           ...
           ###### 
            ...
            bonecons =Abone.constraints.new('COPY_LOCATION')#给骨骼添加一个复制位置约束
            bonecons.target = emp
