...
class FaceCutterOperator(bpy.types.Operator):
    ...
    def print_hint(self):
        ...
        if last == self.overall:
            txt = ['W key : Full-width mode',
                'E key : Easy Edit mode',
                'Ctrl + Z : undo',
                'Q key : Confirm',
                'R key : Cut through',                 
                'Press Esc to exit.']
            ...
            txt = ['(Ctrl + mouse scroll) Number of cuts : ' + str(self.snaps), 
                'Holding Shift key : turn off snapping',
                'A key : Align to closest edge',                
                'Z / X / C / V : Line rotation',
                'F key : Fill lines | D key : 45 degree',
                'S key : Symmetric copy | Ctrl + Z : Undo',
                'Q key : Confirm',
                'R key : Cut through (Shift R : limited)',
                'T key : Cut through and Break apart',
                '1 - 9 keys : Set cuts',
                'Press Esc to exit.']        
        elif last == self.handle_linked:
            txt = ['E key : Exit Easy Edit mode',  
